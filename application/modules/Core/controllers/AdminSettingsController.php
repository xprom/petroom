 ...
 * @version    $Id: AdminSettingsController.php 9761 2012-08-14 00:05:33Z matthew $
 * @author     John
 */
...
//        }
  ...
  public function performanceAction()
  {
    ...
    if(  $form->getElement('translate_array')->getValue() == 1 && $this->getRequest()->isPost() ) {
      ...
      foreach( $languageFolders as $folder){
        ...
        if(count(glob( $folder . '/' . $locale_code . 'php' )) == 0){
          // If Array files do not exist, Create Them
          $this->csv_folder_to_array($folder, $locale_code);                              
        }
      }
  ...
  public function affiliateAction()
  {
    ...
    if( !empty($code) ) {
      ...
      $httpClient->setUri('http://www.socialengine.com/affiliate/check');
